...
public class RepLocalFragment extends Fragment {
    ...
    private static final String LOG_TAG = "RepLocalFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        repArrayList = new Gson().fromJson(sharedpreferences.getString(Constants.LOCAL_ELECTED_MEMBERS, ""), type);
        Log.e(LOG_TAG,"Local List Count "+repArrayList.size());
