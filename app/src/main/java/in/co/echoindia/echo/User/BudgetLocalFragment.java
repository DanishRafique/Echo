...
public class BudgetLocalFragment extends Fragment implements OnChartValueSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        centralBudget = new Gson().fromJson(sharedpreferences.getString(Constants.BUDGET_LOCAL, ""), SpendingModel.class);
        ...
        PieDataSet dataSet = new PieDataSet(centralPieEntry, "Local Budgets");
        ...
        mChart.setCenterText(centralBudget.getSpendingLocal());
