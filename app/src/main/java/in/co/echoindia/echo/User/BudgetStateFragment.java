...
public class BudgetStateFragment extends Fragment implements OnChartValueSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        centralBudget = new Gson().fromJson(sharedpreferences.getString(Constants.BUDGET_STATE, ""), SpendingModel.class);
        ...
        PieDataSet dataSet = new PieDataSet(centralPieEntry, "State Budgets");
        ...
        mChart.setCenterText(centralBudget.getSpendingState());
