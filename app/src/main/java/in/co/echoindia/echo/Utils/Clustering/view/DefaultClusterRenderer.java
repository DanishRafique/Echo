...
package in.co.echoindia.echo.Utils.Clustering.view;
...
import in.co.echoindia.echo.Utils.Clustering.Cluster;
import in.co.echoindia.echo.Utils.Clustering.ClusterItem;
import in.co.echoindia.echo.Utils.Clustering.ClusterManager;
import in.co.echoindia.echo.Utils.Clustering.IconGenerator;
import in.co.echoindia.echo.Utils.Clustering.MarkerManager;
import in.co.echoindia.echo.Utils.Clustering.Point;
import in.co.echoindia.echo.Utils.Clustering.SphericalMercatorProjection;
import in.co.echoindia.echo.Utils.Clustering.SquareTextView;

import static in.co.echoindia.echo.Utils.Clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    private class RenderTask implements Runnable {
        ...
        public void run() {
            ...
            // ODO: Add some padding, so that markers can animate in from off-screen.
            ...
            for (final MarkerWithPosition marker : markersToRemove) {
                ...
                // ODO: drop animation based on speed of device & number of markers to animate.
    ...
    protected void onBeforeClusterRendered(Cluster<T> cluster, MarkerOptions markerOptions) {
        ...
        // ODO: consider adding anchor(.5, .5) (Individual markers will overlap more often)
    ...
    /**
     * Animates a markerWithPosition from one position to another. ODO: improve performance for
