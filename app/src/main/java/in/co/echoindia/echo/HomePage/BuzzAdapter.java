...
public class BuzzAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        buzzFullName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                userNameViewProfile=buzzObj.getPostFirstName()+" "+buzzObj.getPostLastName();
                userImageViewProfile=buzzObj.getPostUserPhoto();
                if(buzzObj.getPostType().equals("USER")){
                    userType="USER";
                }
                else if(buzzObj.getPostType().equals("BUZZ")){
                    userType="REP";
                    userDesignation=buzzObj.getPostRepDesignation();
                    userParty=buzzObj.getPostRepParty();
                }
                ViewUser mViewUser=new ViewUser(buzzObj.getPostUserName());
                mViewUser.execute();
            }
        });
