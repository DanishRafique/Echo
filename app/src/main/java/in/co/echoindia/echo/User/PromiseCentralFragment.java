...
public class PromiseCentralFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Type type = new TypeToken<ArrayList<PromiseModel>>() {}.getType();
        promiseArrayList = new Gson().fromJson(sharedpreferences.getString(Constants.PROMISE_COUNTRY, ""), type);
