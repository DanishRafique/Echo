...
package in.co.echoindia.echo.Utils.Clustering.algo;
...
import in.co.echoindia.echo.Utils.Clustering.Bounds;
...
import in.co.echoindia.echo.Utils.Clustering.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    private Bounds createBoundsFromSpan(Point p, double span) {
        // ODO: Use a span that takes into account the visual size of the marker, not just its
        // LatLng.
